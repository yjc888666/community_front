            ...
            <div class="layui-form layui-form-pane" style="padding: 20px 0;">
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-block">
                            <el-select v-model="clearing" clearable :placeholder="$t('common.choose')">
                                <el-option
                                    v-for="item in cleartype"
                                    :key="item.id"
                                    :label="item.type"
                                    :value="item.id">
                                </el-option>
