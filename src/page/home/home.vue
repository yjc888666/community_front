    ...
    <div>
        <div class="fly-home">
            ...
            <p class="fly-home-info">
                <i class="iconfont icon-zuichun"></i><span style="color: #FF7200;">{{infoDate.point}}</span>
...
//            Ta回复的帖子
            comment(){
                var me=this;
                me.$axios.post(me.url+"/comment/my?page=" + this.pageNum1 + "&size=" + this.pageSize1)
                    .then(function (result) {
...
//            Ta点赞的帖子
            zan(){
                var me=this;
                me.$axios.post(me.url+"/user/zan?target=forum&page=" + this.pageNum2 + "&size=" + this.pageSize2)
                    .then(function (result) {
...
//           Ta关注的用户
            care(){
                var me=this;
                me.$axios.post(me.url+"/user/care")
                    .then(function (result) {
...
//            Ta被打赏记录
            tipsme(){
                var me=this;
                me.$axios.post(me.url+"/user/tipsme?page=" + this.pageNum4 + "&size=" + this.pageSize4)
                    .then(function (result) {
...
//            Ta的打赏记录
            mytips(){
                var me=this;
                me.$axios.post(me.url+"/user/mytips?page=" + this.pageNum5 + "&size=" + this.pageSize5)
                    .then(function (result) {
