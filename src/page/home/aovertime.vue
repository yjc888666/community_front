        ...
        <div class="layui-tab layui-tab-brief" lay-filter="user">
            ...
            <div class="layui-tab-content" style="padding: 20px 0 0;">
                ...
                <div class="time-sec-one">
                    <el-row>
                        <el-col :span="24">
                            <div class="time-info f14">本月加班统计
                                <div class="fr">
...
<script>
    export default {
        ...
        methods: {
            leavetype(){
                var me=this;
                me.$axios.post(me.url+"/rest/overtimeType")
            ...
            clearstype(){
                var me=this;
                me.$axios.post(me.url+"/rest/clearing")
                    .then(function (result) {
                        me.cleartype=result.data;
                    })
            },
            submitForm(formName) {
            ...
            lateEvent(a,b){
                ...
                var para = {
                    startdate:me.ruleForm.startdate,
                    enddate:me.ruleForm.enddate,
                    page:a,
                    size:b
                }
                me.$axios.post(me.url+"/rest/bykey",para)
                    .then(function (result) {
                        ...
                        if(me.tableData.length !=0||me.tableData !=undefined){
                            me.tableData.forEach(function(item){
                                ...
                                me.cleartype.forEach(function(index){
                                    if(item.clearing_from==index.id){
                                        item.clearing_from1=index.type
                                    }
                                })
                            })
            ...
            daoEvent(){
                ...
                if(me.tableData.length ==0||me.tableData.length ==undefined){
                    ...
                    me.$axios({ 
                        method: 'post',
                        url: me.url+"/rest/overtimeExcel", // 请求地址
                        data:{
