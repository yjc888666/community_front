        ...
        <div class="fly-panel" pad20="" style="padding-top: 5px;">
            <div class="layui-tab layui-tab-brief" lay-filter="user">
                ...
                <div class="layui-form layui-form-pane" style="padding: 20px 0;">
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                ...
                                <div class="holiday">{{holiday.type}}</div>
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">{{$t('add.leaveLength')}}</label>
                        <div class="layui-input-block">
                            <div class="holiday">{{holiday.days}}{{$t('common.day')}}</div>
                        </div>
                    </div>
                    <div class="layui-form-item">
...
<script>
    export default {
        ...
        mounted(){
            ...
            var me=this;
            me.$axios.post(me.url+"/leave/get?id="+id)
